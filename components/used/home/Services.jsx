            ...
            <div className="container pt-[75px] md:pt-25 pb-[75px] md:pb-25">
                ...
                <div className="flex flex-wrap mx-[-15px] !mt-[-40px]">
                    ...
                    <div className="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[40px]">
                        <div className="flex flex-row">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 234.67" data-inject-url="https://kodkraft.com/assets/img/icons/solid/search.svg" className="svg-inject icon-svg !w-[2.2rem] !h-[2.2rem]  solid-duo text-grape-fuchsia !mr-4 rtl:!mr-0 rtl:!ml-4"><path className="fill-secondary" d="M117.15 74.85a53.33 53.33 0 1053.33 53.33 53.39 53.39 0 00-53.33-53.33zm0 85.33a32 32 0 1132-32 32 32 0 01-32 32z"></path><path className="fill-secondary" d="M149.7 149.68a10.61 10.61 0 017.53 3.12l31.65 31.65a10.67 10.67 0 01-15.09 15.09l-31.65-31.65a10.67 10.67 0 017.56-18.21z"></path><path className="fill-primary" d="M224 0H32A32 32 0 000 32v170.67a32 32 0 0032 32h192a32 32 0 0032-32V32a32 32 0 00-32-32zm0 213.33H32a10.68 10.68 0 01-10.67-10.67V53.33h213.33v149.33A10.67 10.67 0 01224 213.33z"></path></svg>
                            </div>
                            <div>
                                <h3 className="!text-[1.1rem] !mb-1">{t(pathname, 'services.seo.title')}
                                </h3>
                                <p className="!mb-0">
                                    {t(pathname, 'services.seo.description')}
                                </p>
                            </div>
                        </div>
                    </div>
