  ...
  return (
    <>
      <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px] xl:!mt-0 lg:!mt-0 !mb-12">
        <div className="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full">
          <h3 className="xl:!text-[2rem] !text-[calc(1.325rem_+_0.9vw)] !leading-[1.2] font-DMSerif !font-normal tracking-normal !mb-3 xl:!pr-10 [word-spacing:normal!important]">
            We are proud of our creative team
          </h3>
          <p className="leadlead !text-[1.05rem] !leading-[1.6] font-medium !mb-0 xxl:!pr-10">
          ...
          <div className="flex flex-wrap mx-[-15px] items-center counter-wrapper !mt-[-30px] !text-center">
            <div className="xl:w-4/12 lg:w-4/12 md:w-4/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full">
              <svg
                ...
                className="svg-inject icon-svg !text-[#a07cc5] !mb-3 !w-[2.6rem] !h-[2.6rem] text-aqua m-[0_auto]"
              >
                <path
      ...
      {/* /.row */}
      <div className="flex flex-wrap mx-[-15px] grid-view md:mx-[-20px] lg:mx-[-20px] xl:mx-[-25px] !mt-[-40px] xl:!mt-0 lg:!mt-0 !mb-24 xl:!mb-[9rem] lg:!mb-[9rem] md:!mb-[9rem]">
        <div className="md:w-6/12 lg:w-3/12 xl:w-3/12 w-full flex-[0_0_auto] xl:!px-[25px] lg:!px-[20px] md:!px-[20px] !px-[15px] max-w-full md:!mt-[40px] max-md:!mt-[40px]">
        ...
        <div className="md:w-6/12 lg:w-3/12 xl:w-3/12 w-full flex-[0_0_auto] xl:!px-[25px] lg:!px-[20px] md:!px-[20px] !px-[15px] max-w-full md:!mt-[40px] max-md:!mt-[40px]">
          <div className="!relative">
            <div
              className="shape !rounded-[.4rem] !bg-[#fcf0f1] rellax xl:block lg:block md:block absolute"
              data-rellax-speed={0}
              style={{
                bottom: "-0.75rem",
                right: "-0.75rem",
        ...
        <div className="md:w-6/12 lg:w-3/12 xl:w-3/12 w-full flex-[0_0_auto] xl:!px-[25px] lg:!px-[20px] md:!px-[20px] !px-[15px] max-w-full md:!mt-[40px] max-md:!mt-[40px]">
          <div className="!relative">
            <div
              className="shape !rounded-[.4rem] !bg-[#edf9f6] rellax xl:block lg:block md:block absolute"
              data-rellax-speed={0}
              style={{
                bottom: "-0.75rem",
                right: "-0.75rem",
        ...
        <div className="md:w-6/12 lg:w-3/12 xl:w-3/12 w-full flex-[0_0_auto] xl:!px-[25px] lg:!px-[20px] md:!px-[20px] !px-[15px] max-w-full md:!mt-[40px] max-md:!mt-[40px]">
          <div className="!relative">
            <div
              className="shape !rounded-[.4rem] !bg-[#f6f3f9] rellax xl:block lg:block md:block absolute"
              data-rellax-speed={0}
              style={{
                bottom: "-0.75rem",
                right: "-0.75rem",
