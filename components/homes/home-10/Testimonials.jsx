...
export default function Testimonials() {
  return (
    <div
      className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] !mt-[-8rem] xl:!mt-[-17.5rem] lg:!mt-[-17.5rem] md:!mt-[-17.5rem] !mb-[4.5rem] xl:!mb-[8rem] lg:!mb-[8rem] md:!mb-[8rem]"
