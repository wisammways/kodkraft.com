  ...
  <div class="grow shrink-0">
            ...
            <div class="offcanvas-body xl:!ml-auto lg:!ml-auto flex  flex-col !h-full">
              <ul class="navbar-nav">
                <li class="nav-item dropdown dropdown-mega">
                  <a class="nav-link dropdown-toggle  font-bold tracking-[-0.01rem] hover:!text-[#d16b86] after:!text-[#d16b86]" href="#" data-bs-toggle="dropdown">Demos</a>
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle  font-bold tracking-[-0.01rem] hover:!text-[#d16b86] after:!text-[#d16b86]" href="#" data-bs-toggle="dropdown">Pages</a>
                  <ul class="dropdown-menu">
                    <li class="dropdown dropdown-submenu dropend"><a class="dropdown-item hover:!text-[#d16b86] dropdown-toggle" href="#" data-bs-toggle="dropdown">Services</a>
                      <ul class="dropdown-menu">
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./services.html">Services I</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./services2.html">Services II</a></li>
                      </ul>
                    </li>
                    <li class="dropdown dropdown-submenu dropend"><a class="dropdown-item hover:!text-[#d16b86] dropdown-toggle" href="#" data-bs-toggle="dropdown">About</a>
                      <ul class="dropdown-menu">
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./about.html">About I</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./about2.html">About II</a></li>
                      </ul>
                    </li>
                    <li class="dropdown dropdown-submenu dropend"><a class="dropdown-item hover:!text-[#d16b86] dropdown-toggle" href="#" data-bs-toggle="dropdown">Shop</a>
                      <ul class="dropdown-menu">
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./shop.html">Shop I</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./shop2.html">Shop II</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./shop-product.html">Product Page</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./shop-cart.html">Shopping Cart</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./shop-checkout.html">Checkout</a></li>
                      </ul>
                    </li>
                    <li class="dropdown dropdown-submenu dropend"><a class="dropdown-item hover:!text-[#d16b86] dropdown-toggle" href="#" data-bs-toggle="dropdown">Contact</a>
                      <ul class="dropdown-menu">
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./contact.html">Contact I</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./contact2.html">Contact II</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./contact3.html">Contact III</a></li>
                      </ul>
                    </li>
                    <li class="dropdown dropdown-submenu dropend"><a class="dropdown-item hover:!text-[#d16b86] dropdown-toggle" href="#" data-bs-toggle="dropdown">Career</a>
                      <ul class="dropdown-menu">
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./career.html">Job Listing I</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./career2.html">Job Listing II</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./career-job.html">Job Description</a></li>
                      </ul>
                    </li>
                    <li class="dropdown dropdown-submenu dropend"><a class="dropdown-item hover:!text-[#d16b86] dropdown-toggle" href="#" data-bs-toggle="dropdown">Utility</a>
                      <ul class="dropdown-menu">
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./404.html">404 Not Found</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./page-loader.html">Page Loader</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./signin.html">Sign In I</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./signin2.html">Sign In II</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./signup.html">Sign Up I</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./signup2.html">Sign Up II</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./terms.html">Terms</a></li>
                      </ul>
                    </li>
                    <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./pricing.html">Pricing</a></li>
                    <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./onepage.html">One Page</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle  font-bold tracking-[-0.01rem] hover:!text-[#d16b86] after:!text-[#d16b86]" href="#" data-bs-toggle="dropdown">Projects</a>
                  <div class="dropdown-menu dropdown-lg">
                    <div class="dropdown-lg-content">
                      <div>
                        <h6 class="dropdown-header !text-[#d16b86]">Project Pages</h6>
                        <ul class="pl-0 list-none">
                          <li><a class="dropdown-item hover:!text-[#d16b86]" href="./projects.html">Projects I</a></li>
                          <li><a class="dropdown-item hover:!text-[#d16b86]" href="./projects2.html">Projects II</a></li>
                          <li><a class="dropdown-item hover:!text-[#d16b86]" href="./projects3.html">Projects III</a></li>
                          <li><a class="dropdown-item hover:!text-[#d16b86]" href="./projects4.html">Projects IV</a></li>
                        </ul>
                      </div>
                      <!-- /.column -->
                      <div>
                        <h6 class="dropdown-header !text-[#d16b86]">Single Projects</h6>
                        <ul class="pl-0 list-none">
                          <li><a class="dropdown-item hover:!text-[#d16b86]" href="./single-project.html">Single Project I</a></li>
                          <li><a class="dropdown-item hover:!text-[#d16b86]" href="./single-project2.html">Single Project II</a></li>
                          <li><a class="dropdown-item hover:!text-[#d16b86]" href="./single-project3.html">Single Project III</a></li>
                          <li><a class="dropdown-item hover:!text-[#d16b86]" href="./single-project4.html">Single Project IV</a></li>
                        </ul>
                      </div>
                      <!-- /.column -->
                    </div>
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle  font-bold tracking-[-0.01rem] hover:!text-[#d16b86] after:!text-[#d16b86]" href="#" data-bs-toggle="dropdown">Blog</a>
                  <ul class="dropdown-menu">
                    <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./blog.html">Blog without Sidebar</a></li>
                    <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./blog2.html">Blog with Sidebar</a></li>
                    <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./blog3.html">Blog with Left Sidebar</a></li>
                    <li class="dropdown dropdown-submenu dropend"><a class="dropdown-item hover:!text-[#d16b86] dropdown-toggle" href="#" data-bs-toggle="dropdown">Blog Posts</a>
                      <ul class="dropdown-menu">
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./blog-post.html">Post without Sidebar</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./blog-post2.html">Post with Sidebar</a></li>
                        <li class="nav-item"><a class="dropdown-item hover:!text-[#d16b86]" href="./blog-post3.html">Post with Left Sidebar</a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown dropdown-mega">
                  <a class="nav-link dropdown-toggle  font-bold tracking-[-0.01rem] hover:!text-[#d16b86] after:!text-[#d16b86]" href="#" data-bs-toggle="dropdown">Blocks</a>
                  <ul class="dropdown-menu mega-menu mega-menu-dark mega-menu-img">
                ...
                <li class="nav-item dropdown dropdown-mega">
                  <a class="nav-link dropdown-toggle  font-bold tracking-[-0.01rem] hover:!text-[#d16b86] after:!text-[#d16b86]" href="#" data-bs-toggle="dropdown">Documentation</a>
                  <ul class="dropdown-menu mega-menu">
                    <li class="mega-menu-content">
                      <div class="flex flex-wrap mx-0 xl:mx-[-7.5px] lg:mx-[-7.5px]">
                        <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] max-w-full">
                          <h6 class="dropdown-header !text-[#d16b86]">Usage</h6>
                          <ul class="pl-0 list-none  xl:columns-2 lg:columns-2  xl:pb-1 lg:pb-1">
      <li class="xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/index.html">Get Started</a></li>
      <li class="xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/forms.html">Forms</a></li>
      <li class="xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/faq.html">FAQ</a></li>
      <li class="xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/changelog.html">Changelog</a></li>
      <li class="xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/credits.html">Credits</a></li>
                          </ul>
                          <h6 class="dropdown-header !text-[#d16b86] xl:!mt-6 lg:!mt-6">Styleguide</h6>
                          <ul class="pl-0 list-none  xl:columns-2 lg:columns-2 ">
    <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/styleguide/colors.html">Colors</a></li>
    <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/styleguide/fonts.html">Fonts</a></li>
    <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/styleguide/icons-svg.html">SVG Icons</a></li>
    <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/styleguide/icons-font.html">Font Icons</a></li>
    <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/styleguide/illustrations.html">Illustrations</a></li>
    <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/styleguide/backgrounds.html">Backgrounds</a></li>
    <li class=" xl:inline-block xl:w-full lg:inline-block lg:w-full"><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/styleguide/misc.html">Misc</a></li>
                          </ul>
                        </div>
                        <!--/column -->
                        <div class="xl:w-8/12 lg:w-8/12 w-full flex-[0_0_auto] max-w-full xl:border-l-[rgba(164,174,198,0.2)] xl:border-l xl:border-solid lg:border-l-[rgba(164,174,198,0.2)] lg:border-l lg:border-solid">
                          <h6 class="dropdown-header !text-[#d16b86]">Elements</h6>
                          <ul class="pl-0 list-none  xl:columns-3 lg:columns-3 ">
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/accordion.html">Accordion</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/alerts.html">Alerts</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/animations.html">Animations</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/avatars.html">Avatars</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/background.html">Background</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/badges.html">Badges</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/buttons.html">Buttons</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/card.html">Card</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/carousel.html">Carousel</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/dividers.html">Dividers</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/form-elements.html">Form Elements</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/image-hover.html">Image Hover</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/image-mask.html">Image Mask</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/lightbox.html">Lightbox</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/player.html">Media Player</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/modal.html">Modal</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/pagination.html">Pagination</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/progressbar.html">Progressbar</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/shadows.html">Shadows</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/shapes.html">Shapes</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/tables.html">Tables</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/tabs.html">Tabs</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/text-animations.html">Text Animations</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/text-highlight.html">Text Highlight</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/tiles.html">Tiles</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/tooltips-popovers.html">Tooltips & Popovers</a></li>
                            <li><a class="dropdown-item hover:!text-[#d16b86]" href="./docs/elements/typography.html">Typography</a></li>
                          </ul>
                        </div>
                        <!--/column -->
                      </div>
      ...
      <div class="container pt-10 pb-[4.5rem] xl:pb-24 lg:pb-24 md:pb-24">
          ...
          <div class="swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <figure class="overlay caption caption-overlay rounded  !mb-0"><a href="#"> <img src="./assets/img/photos/tb1.jpg" alt="image"></a>
              ...
              <!--/.swiper-slide -->
              <div class="swiper-slide">
                <figure class="overlay caption caption-overlay rounded  !mb-0"><a href="#"> <img src="./assets/img/photos/tb2.jpg" alt="image"></a>
                  <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                    ...
                    <ul class="text-[0.75rem] text-[#aab0bc] m-0 p-0 list-none text-white  !mb-0">
                      ...
                      <li class="post-author inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-user pr-[0.2rem] align-[-.05rem] before:content-['\ed6f']"></i><span>By Sandbox</span></a></li>
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>5<span> Comments</span></a></li>
                    </ul>
                    <!-- /.post-meta -->
                  </figcaption>
                  <!-- /figcaption -->
              ...
              <!--/.swiper-slide -->
              <div class="swiper-slide">
                <figure class="overlay caption caption-overlay rounded  !mb-0"><a href="#"> <img src="./assets/img/photos/tb3.jpg" alt="image"></a>
                  <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                    ...
                    <ul class="text-[0.75rem] text-[#aab0bc] m-0 p-0 list-none text-white  !mb-0">
                      <li class="post-date inline-block"><i class="uil uil-calendar-alt pr-[0.2rem] align-[-.05rem] before:content-['\e9ba']"></i><span>23 Jun 2022</span></li>
                      <li class="post-author inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-user pr-[0.2rem] align-[-.05rem] before:content-['\ed6f']"></i><span>By Sandbox</span></a></li>
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>8<span> Comments</span></a></li>
                    </ul>
                    <!-- /.post-meta -->
                  </figcaption>
                  <!-- /figcaption -->
              ...
              <!--/.swiper-slide -->
              <div class="swiper-slide">
                <figure class="overlay caption caption-overlay rounded  !mb-0"><a href="#"> <img src="./assets/img/photos/tb4.jpg" alt="image"></a>
                  <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                    ...
                    <ul class="text-[0.75rem] text-[#aab0bc] m-0 p-0 list-none text-white  !mb-0">
                      <li class="post-date inline-block"><i class="uil uil-calendar-alt pr-[0.2rem] align-[-.05rem] before:content-['\e9ba']"></i><span>15 Apr 2022</span></li>
                      <li class="post-author inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-user pr-[0.2rem] align-[-.05rem] before:content-['\ed6f']"></i><span>By Sandbox</span></a></li>
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>9<span> Comments</span></a></li>
                    </ul>
                    <!-- /.post-meta -->
                  </figcaption>
                  <!-- /figcaption -->
              ...
              <!--/.swiper-slide -->
              <div class="swiper-slide">
                <figure class="overlay caption caption-overlay rounded  !mb-0"><a href="#"> <img src="./assets/img/photos/tb5.jpg" alt="image"></a>
                  <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                    ...
                    <ul class="text-[0.75rem] text-[#aab0bc] m-0 p-0 list-none text-white  !mb-0">
                      <li class="post-date inline-block"><i class="uil uil-calendar-alt pr-[0.2rem] align-[-.05rem] before:content-['\e9ba']"></i><span>14 Feb 2022</span></li>
                      <li class="post-author inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-user pr-[0.2rem] align-[-.05rem] before:content-['\ed6f']"></i><span>By Sandbox</span></a></li>
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>11<span> Comments</span></a></li>
                    </ul>
                    <!-- /.post-meta -->
                  </figcaption>
                  <!-- /figcaption -->
              ...
              <!--/.swiper-slide -->
              <div class="swiper-slide">
                <figure class="overlay caption caption-overlay rounded  !mb-0"><a href="#"> <img src="./assets/img/photos/tb6.jpg" alt="image"></a>
                  <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                    ...
                    <ul class="text-[0.75rem] text-[#aab0bc] m-0 p-0 list-none text-white  !mb-0">
                      <li class="post-date inline-block"><i class="uil uil-calendar-alt pr-[0.2rem] align-[-.05rem] before:content-['\e9ba']"></i><span>22 Jan 2022</span></li>
                      <li class="post-author inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-user pr-[0.2rem] align-[-.05rem] before:content-['\ed6f']"></i><span>By Sandbox</span></a></li>
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>8<span> Comments</span></a></li>
                    </ul>
                    <!-- /.post-meta -->
              ...
              <!--/.swiper-slide -->
              <div class="swiper-slide">
                <figure class="overlay caption caption-overlay rounded  !mb-0"><a href="#"> <img src="./assets/img/photos/tb7.jpg" alt="image"></a>
                  <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                    <span class="badge badge-lg bg-[rgba(255,255,255)] opacity-100 uppercase !mb-3">Nature</span>
                    ...
                    <ul class="text-[0.75rem] text-[#aab0bc] m-0 p-0 list-none text-white  !mb-0">
                      ...
                      <li class="post-author inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-user pr-[0.2rem] align-[-.05rem] before:content-['\ed6f']"></i><span>By Sandbox</span></a></li>
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>14<span> Comments</span></a></li>
                    </ul>
                    <!-- /.post-meta -->
                  </figcaption>
                  <!-- /figcaption -->
        ...
        <div class="flex flex-wrap mx-[-15px]">
          <div class="lg:w-full xl:w-10/12 xxl:w-8/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto !text-center">
            <h2 class="xl:text-[1.7rem] text-[calc(1.295rem_+_0.54vw)] !leading-[1.25] font-semibold !text-center mt-4 mb-10">Hello! I'm Caitlyn. Welcome to my blog. Here on this blog you will be able to find travel diary with traveling tips.</h2>
          </div>
          <!--/column -->
        </div>
        <!--/.row -->
        <div class="flex flex-wrap mx-[-15px] grid-view md:mx-[-20px] lg:mx-[-20px] xl:mx-[-25px] mt-[-40px] xl:mt-0 lg:mt-0 !text-center">
          <div class="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto md:px-[20px] lg:px-[20px] xl:px-[25px] mt-[40px] xl:mt-0 lg:mt-0">
            <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
              <figure class="card-img-top overlay overlay-1 group">
                <a href="#"><img class="max-w-full h-auto" src="./assets/img/photos/f1.jpg" alt="image"></a>
                <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                  <h5 class="from-top !mb-0 !absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 !text-white">Read Details</h5>
                </figcaption>
              </figure>
          ...
          <div class="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto md:px-[20px] lg:px-[20px] xl:px-[25px] mt-[40px] xl:mt-0 lg:mt-0">
            <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
              <figure class="card-img-top overlay overlay-1 group">
                <a href="#"><img class="max-w-full h-auto" src="./assets/img/photos/f2.jpg" alt="image"></a>
                <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                  <h5 class="from-top !mb-0 !absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 !text-white">See Destinations</h5>
                </figcaption>
              </figure>
              <div class="card-body p-5">
          ...
          <div class="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto md:px-[20px] lg:px-[20px] xl:px-[25px] mt-[40px] xl:mt-0 lg:mt-0">
            <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
              <figure class="card-img-top overlay overlay-1 group">
                <a href="#"><img class="max-w-full h-auto" src="./assets/img/photos/f3.jpg" alt="image"></a>
                <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                  <h5 class="from-top !mb-0 !absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 !text-white">Follow Me</h5>
                </figcaption>
              </figure>
              <div class="card-body p-5">
        ...
        <!--/.row -->
        <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] mt-[7rem]">
          <div class="xl:w-8/12 lg:w-8/12 w-full flex-[0_0_auto] px-[15px] max-w-full lg:px-[20px] xl:px-[35px] xl:!mt-0 lg:!mt-0">
            <div class="blog classic-view">
              <article class="post mb-8">
                <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                  <figure class="card-img-top overlay overlay-1 group"><a href="./blog-post.html"><img src="./assets/img/photos/tb8.jpg" alt="image"></a>
                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                      <h5 class="from-top  !mb-0 absolute w-full translate-y-[-80%] p-[.75rem_1rem] left-0 top-2/4">Read More</h5>
                    </figcaption>
                  </figure>
                  <div class="card-body flex-[1_1_auto] xl:p-[2rem_2.5rem_1.25rem] lg:p-[2rem_2.5rem_1.25rem] md:p-[2rem_2.5rem_1.25rem] p-[40px]">
                    <div class="post-header !mb-[.9rem]">
                      <div class="post-category mb-[.4rem] uppercase tracking-[0.02rem] text-[#aab0bc]">
                        <a href="#" class="hover text-[#605dba] focus:text-[#605dba] hover:text-[#605dba]" rel="category">Architecture</a>
                      </div>
                      <!-- /.post-category -->
                      <h2 class="post-title mt-1 !leading-[1.35] !mb-0 "><a class="text-[#343f52] focus:text-[#343f52] hover:text-[#343f52]" href="./blog-post.html">Amet Dolor Bibendum Parturient Cursus</a></h2>
                    </div>
                    <!-- /.post-header -->
                    <div class="!relative">
                  ...
                  <div class="card-footer xl:p-[1.25rem_2.5rem_1.25rem] lg:p-[1.25rem_2.5rem_1.25rem] md:p-[1.25rem_2.5rem_1.25rem] p-[18px_40px]">
                    <ul class="text-[.75rem] text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                      ...
                      <li class="post-author inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-user pr-[0.2rem] align-[-.05rem] before:content-['\ed6f']"></i><span>By Sandbox</span></a></li>
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>3<span> Comments</span></a></li>
                      <li class="post-likes !ml-auto inline-block"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-heart-alt pr-[0.2rem] align-[-.05rem] before:content-['\eb60']"></i>3</a></li>
                    </ul>
                    <!-- /.post-meta -->
                  </div>
                  <!-- /.card-footer -->
              ...
              <article class="post mb-8">
                <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                  <figure class="card-img-top overlay overlay-1 group"><a href="./blog-post.html"><img src="./assets/img/photos/tb9.jpg" alt="image"></a>
                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                      <h5 class="from-top  !mb-0 absolute w-full translate-y-[-80%] p-[.75rem_1rem] left-0 top-2/4">Read More</h5>
                    </figcaption>
                  </figure>
                  <div class="card-body flex-[1_1_auto] xl:p-[2rem_2.5rem_1.25rem] lg:p-[2rem_2.5rem_1.25rem] md:p-[2rem_2.5rem_1.25rem] p-[40px]">
                    <div class="post-header !mb-[.9rem]">
                      <div class="post-category mb-[.4rem] uppercase tracking-[0.02rem] text-[#aab0bc]">
                        <a href="#" class="hover text-[#e668b3] focus:text-[#e668b3] hover:text-[#e668b3]" rel="category">Restaurants</a>
                      </div>
                      <!-- /.post-category -->
                      <h2 class="post-title mt-1 !leading-[1.35] !mb-0 "><a class="text-[#343f52] focus:text-[#343f52] hover:text-[#343f52]" href="./blog-post.html">Fringilla Ligula Pharetra Amet</a></h2>
                    </div>
                    <!-- /.post-header -->
                    <div class="!relative">
                      <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Nullam quis risus eget urna mollis ornare vel. Nulla vitae elit libero, a pharetra augue. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Sed posuere consectetur est at lobortis. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh. Cras mattis consectetur purus.</p>
                  ...
                  <div class="card-footer xl:p-[1.25rem_2.5rem_1.25rem] lg:p-[1.25rem_2.5rem_1.25rem] md:p-[1.25rem_2.5rem_1.25rem] p-[18px_40px]">
                    <ul class="text-[.75rem] text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                      ...
                      <li class="post-author inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-user pr-[0.2rem] align-[-.05rem] before:content-['\ed6f']"></i><span>By Sandbox</span></a></li>
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>5<span> Comments</span></a></li>
                      <li class="post-likes !ml-auto inline-block"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-heart-alt pr-[0.2rem] align-[-.05rem] before:content-['\eb60']"></i>4</a></li>
                    </ul>
                    <!-- /.post-meta -->
                  </div>
                  <!-- /.card-footer -->
              ...
              <article class="post mb-8">
                <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                  <div class="card-img-top">
                    <div class="player relative z-[2] rounded-[0.4rem]" data-plyr-provider="youtube" data-plyr-embed-id="hxeITyt_XfU"></div>
                  </div>
                  <div class="card-body flex-[1_1_auto] xl:p-[2rem_2.5rem_1.25rem] lg:p-[2rem_2.5rem_1.25rem] md:p-[2rem_2.5rem_1.25rem] p-[40px]">
                    <div class="post-header !mb-[.9rem]">
                      <div class="post-category mb-[.4rem] uppercase tracking-[0.02rem] text-[#aab0bc]">
                        <a href="#" class="hover text-[#5eb9f0] focus:text-[#5eb9f0] hover:text-[#5eb9f0]" rel="category">Nature</a>
                      </div>
                      <!-- /.post-category -->
                      <h2 class="post-title mt-1 !leading-[1.35] !mb-0 "><a class="text-[#343f52] focus:text-[#343f52] hover:text-[#343f52]" href="./blog-post.html">Consectetur Bibendum Sollicitudin Vulputate</a></h2>
                    </div>
                    <!-- /.post-header -->
                    <div class="!relative">
                      <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Nullam quis risus eget urna mollis ornare vel. Nulla vitae elit libero, a pharetra augue. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Sed posuere consectetur est at lobortis. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh. Cras mattis consectetur purus.</p>
                  ...
                  <div class="card-footer xl:p-[1.25rem_2.5rem_1.25rem] lg:p-[1.25rem_2.5rem_1.25rem] md:p-[1.25rem_2.5rem_1.25rem] p-[18px_40px]">
                    <ul class="text-[.75rem] text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                      ...
                      <li class="post-author inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-user pr-[0.2rem] align-[-.05rem] before:content-['\ed6f']"></i><span>By Sandbox</span></a></li>
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>8<span> Comments</span></a></li>
                      <li class="post-likes !ml-auto inline-block"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-heart-alt pr-[0.2rem] align-[-.05rem] before:content-['\eb60']"></i>6</a></li>
                    </ul>
                    <!-- /.post-meta -->
                  </div>
                  <!-- /.card-footer -->
            ...
            <div class="blog itemgrid grid-view">
              <div class="flex flex-wrap mx-[-15px] isotope xl:mx-[-20px] lg:mx-[-20px] md:mx-[-20px] mt-[-40px] !mb-8">
                <article class="item post xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] xl:px-[20px] lg:px-[20px] md:px-[20px] mt-[40px] px-[15px] max-w-full">
                  <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                    <figure class="card-img-top overlay overlay-1 group"><a href="#"> <img src="./assets/img/photos/tb10.jpg" alt="image"></a>
                      <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                        <h5 class="from-top  !mb-0 absolute w-full translate-y-[-80%] p-[.75rem_1rem] left-0 top-2/4">Read More</h5>
                      </figcaption>
                    </figure>
                    <div class="card-body flex-[1_1_auto] p-[1.75rem_1.75rem_1rem_1.75rem] sm:p-[40px_40px_20px] xsm:p-[40px_40px_20px]">
                      <div class="post-header">
                        <div class="post-category mb-[.4rem] uppercase tracking-[0.02rem] text-[#aab0bc]">
                          <a href="#" class="hover text-[#fab758] focus:text-[#fab758] hover:text-[#fab758]" rel="category">Roadtrip</a>
                        </div>
                        <!-- /.post-category -->
                        <h2 class="post-title h3 !mt-1 !mb-3"><a class="text-[#343f52] focus:text-[#343f52] hover:text-[#343f52]" href="./blog-post.html">Ligula tristique quis risus</a></h2>
                      </div>
                      <!-- /.post-header -->
                      <div class="!relative">
                    ...
                    <div class="card-footer xl:p-[1.25rem_1.75rem_1.25rem] lg:p-[1.25rem_1.75rem_1.25rem] md:p-[1.25rem_1.75rem_1.25rem] p-[18px_40px]">
                      <ul class="text-[.75rem] text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                        ...
                        <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>4</a></li>
                        <li class="post-likes !ml-auto inline-block"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-heart-alt pr-[0.2rem] align-[-.05rem] before:content-['\eb60']"></i>5</a></li>
                      </ul>
                      <!-- /.post-meta -->
                    </div>
                    <!-- /.card-footer -->
                ...
                <article class="item post xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] xl:px-[20px] lg:px-[20px] md:px-[20px] mt-[40px] px-[15px] max-w-full">
                  <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                    <figure class="card-img-top overlay overlay-1 group"><a href="#"> <img src="./assets/img/photos/tb11.jpg" alt="image"></a>
                      <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                        <h5 class="from-top  !mb-0 absolute w-full translate-y-[-80%] p-[.75rem_1rem] left-0 top-2/4">Read More</h5>
                      </figcaption>
                    </figure>
                    <div class="card-body flex-[1_1_auto] p-[1.75rem_1.75rem_1rem_1.75rem] sm:p-[40px_40px_20px] xsm:p-[40px_40px_20px]">
                      <div class="post-header">
                        <div class="post-category mb-[.4rem] uppercase tracking-[0.02rem] text-[#aab0bc]">
                          <a href="#" class="hover text-[#54a8c7] focus:text-[#54a8c7] hover:text-[#54a8c7]" rel="category">Historic</a>
                        </div>
                        <!-- /.post-category -->
                        <h2 class="post-title h3 !mt-1 !mb-3"><a class="text-[#343f52] focus:text-[#343f52] hover:text-[#343f52]" href="./blog-post.html">Nullam id dolor elit id nibh</a></h2>
                      </div>
                      <!-- /.post-header -->
                      <div class="!relative">
                        <p>Mauris convallis non ligula non interdum. Gravida vulputate convallis tempus vestibulum cras imperdiet nun eu dolor. Aenean lacinia bibendum nulla sed.</p>
                    ...
                    <div class="card-footer xl:p-[1.25rem_1.75rem_1.25rem] lg:p-[1.25rem_1.75rem_1.25rem] md:p-[1.25rem_1.75rem_1.25rem] p-[18px_40px]">
                      <ul class="text-[.75rem] text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                        ...
                        <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>3</a></li>
                        <li class="post-likes !ml-auto inline-block"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-heart-alt pr-[0.2rem] align-[-.05rem] before:content-['\eb60']"></i>3</a></li>
                      </ul>
                      <!-- /.post-meta -->
                    </div>
                ...
                <article class="item post xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] xl:px-[20px] lg:px-[20px] md:px-[20px] mt-[40px] px-[15px] max-w-full">
                  <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                    <figure class="card-img-top overlay overlay-1 group"><a href="#"> <img src="./assets/img/photos/tb12.jpg" alt="image"></a>
                      <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                        <h5 class="from-top  !mb-0 absolute w-full translate-y-[-80%] p-[.75rem_1rem] left-0 top-2/4">Read More</h5>
                      </figcaption>
                    </figure>
                    <div class="card-body flex-[1_1_auto] p-[1.75rem_1.75rem_1rem_1.75rem] sm:p-[40px_40px_20px] xsm:p-[40px_40px_20px]">
                      <div class="post-header">
                        <div class="post-category mb-[.4rem] uppercase tracking-[0.02rem] text-[#aab0bc]">
                          <a href="#" class="hover text-[#f78b77] focus:text-[#f78b77] hover:text-[#f78b77]" rel="category">Cities</a>
                        </div>
                        <!-- /.post-category -->
                        <h2 class="post-title h3 !mt-1 !mb-3"><a class="text-[#343f52] focus:text-[#343f52] hover:text-[#343f52]" href="./blog-post.html">Ultricies fusce porta elit</a></h2>
                      </div>
                      <!-- /.post-header -->
                      <div class="!relative">
                        <p>Mauris convallis non ligula non interdum. Gravida vulputate convallis tempus vestibulum cras imperdiet nun eu dolor. Aenean lacinia bibendum nulla sed.</p>
                    ...
                    <div class="card-footer xl:p-[1.25rem_1.75rem_1.25rem] lg:p-[1.25rem_1.75rem_1.25rem] md:p-[1.25rem_1.75rem_1.25rem] p-[18px_40px]">
                      <ul class="text-[.75rem] text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                        ...
                        <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>6</a></li>
                        <li class="post-likes !ml-auto inline-block"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-heart-alt pr-[0.2rem] align-[-.05rem] before:content-['\eb60']"></i>3</a></li>
                      </ul>
                      <!-- /.post-meta -->
                    </div>
                ...
                <article class="item post xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] xl:px-[20px] lg:px-[20px] md:px-[20px] mt-[40px] px-[15px] max-w-full">
                  <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                    <figure class="card-img-top overlay overlay-1 group"><a href="#"> <img src="./assets/img/photos/tb13.jpg" alt="image"></a>
                      <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                        <h5 class="from-top  !mb-0 absolute w-full translate-y-[-80%] p-[.75rem_1rem] left-0 top-2/4">Read More</h5>
                      </figcaption>
                    </figure>
                    <div class="card-body flex-[1_1_auto] p-[1.75rem_1.75rem_1rem_1.75rem] sm:p-[40px_40px_20px] xsm:p-[40px_40px_20px]">
                      <div class="post-header">
                        <div class="post-category mb-[.4rem] uppercase tracking-[0.02rem] text-[#aab0bc]">
                          <a href="#" class="hover text-[#7cb798] focus:text-[#7cb798] hover:text-[#7cb798]" rel="category">Beaches</a>
                        </div>
                        <!-- /.post-category -->
                        <h2 class="post-title h3 !mt-1 !mb-3"><a class="text-[#343f52] focus:text-[#343f52] hover:text-[#343f52]" href="./blog-post.html">Morbi leo risus porta eget</a></h2>
                      </div>
                      <div class="!relative">
                        <p>Mauris convallis non ligula non interdum. Gravida vulputate convallis tempus vestibulum cras imperdiet nun eu dolor. Aenean lacinia bibendum nulla sed.</p>
                      </div>
                    ...
                    <div class="card-footer xl:p-[1.25rem_1.75rem_1.25rem] lg:p-[1.25rem_1.75rem_1.25rem] md:p-[1.25rem_1.75rem_1.25rem] p-[18px_40px]">
                      <ul class="text-[.75rem] text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                        ...
                        <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>2</a></li>
                        <li class="post-likes !ml-auto inline-block"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-heart-alt pr-[0.2rem] align-[-.05rem] before:content-['\eb60']"></i>5</a></li>
                      </ul>
                      <!-- /.post-meta -->
                    </div>
            ...
            <nav class="flex" aria-label="pagination">
              <ul class="pagination pagination-alt">
                ...
                <li class="page-item"><a class="page-link hover:!text-[#d16b86]" href="#">2</a></li>
                <li class="page-item"><a class="page-link hover:!text-[#d16b86]" href="#">3</a></li>
                <li class="page-item">
                  <a class="page-link hover:!text-[#d16b86]" href="#" aria-label="Next">
          ...
          <aside class="xl:w-4/12 lg:w-4/12 flex-[0_0_auto] px-[15px] max-w-full sidebar mt-8 lg:px-[20px] xl:px-[35px] xl:!mt-0 lg:!mt-0">
            <div class="widget">
              ...
              <figure class="!rounded-[.4rem] mb-4"><img class="max-w-full h-auto !rounded-[.4rem]" src="./assets/img/photos/f1.jpg" alt="image"></figure>
            ...
            <div class="widget mt-[40px]">
              ...
              <ul class="m-0 p-0 after:content-[''] after:block after:h-0 after:clear-both after:invisible">
                <li class=" clear-both block overflow-hidden">
                  <figure class="!rounded-[.4rem] float-left w-14 !h-[4.5rem]"><a href="./blog-post.html"><img class="!rounded-[.4rem]" src="./assets/img/photos/a4.jpg" alt="image"></a></figure>
                  <div class="!relative ml-[4.25rem] mb-0">
                    <h6 class="!mb-2"> <a class="text-[#343f52] hover:text-[#d16b86]" href="./blog-post.html">Magna Mollis Ultricies</a> </h6>
                ...
                <li class=" clear-both block overflow-hidden mt-4">
                  <figure class="!rounded-[.4rem] float-left w-14 !h-[4.5rem]"> <a href="./blog-post.html"><img class="!rounded-[.4rem]" src="./assets/img/photos/a5.jpg" alt="image"></a></figure>
                  <div class="!relative ml-[4.25rem] mb-0">
                    <h6 class="!mb-2"> <a class="text-[#343f52] hover:text-[#d16b86]" href="./blog-post.html">Ornare Nullam Risus</a> </h6>
                    <ul class="text-[.75rem] text-[#aab0bc] m-0 p-0 list-none">
                ...
                <li class=" clear-both block overflow-hidden mt-4">
                  <figure class="!rounded-[.4rem] float-left w-14 !h-[4.5rem]"><a href="./blog-post.html"><img class="!rounded-[.4rem]" src="./assets/img/photos/a6.jpg" alt="image"></a></figure>
                  <div class="!relative ml-[4.25rem] mb-0">
                    <h6 class="!mb-2"> <a class="text-[#343f52] hover:text-[#d16b86]" href="./blog-post.html">Euismod Nullam Fusce</a> </h6>
                    <ul class="text-[.75rem] text-[#aab0bc] m-0 p-0 list-none">
                      ...
                      <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="text-[#aab0bc] hover:text-[#d16b86] hover:border-[#d16b86]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>5</a></li>
                    </ul>
                    <!-- /.post-meta -->
                  </div>
                </li>
        ...
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:text-[#d16b86] before:font-SansSerif"><a class="text-inherit hover:text-[#d16b86]" href="#">Teamwork (21)</a></li>
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:text-[#d16b86] before:font-SansSerif mt-[.35rem]"><a class="text-inherit hover:text-[#d16b86]" href="#">Ideas (19)</a></li>
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:text-[#d16b86] before:font-SansSerif mt-[.35rem]"><a class="text-inherit hover:text-[#d16b86]" href="#">Workspace (16)</a></li>
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:text-[#d16b86] before:font-SansSerif mt-[.35rem]"><a class="text-inherit hover:text-[#d16b86]" href="#">Coding (7)</a></li>
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:text-[#d16b86] before:font-SansSerif mt-[.35rem]"><a class="text-inherit hover:text-[#d16b86]" href="#">Meeting (12)</a></li>
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:text-[#d16b86] before:font-SansSerif mt-[.35rem]"><a class="text-inherit hover:text-[#d16b86]" href="#">Business Tips (14)</a></li>
              </ul>
            </div>
            <!-- /.widget -->
            <div class="widget mt-[40px]">
    ...
    <li class=" mt-0 mb-[0.45rem] mr-[0.2rem] inline-block"><a href="#" class="btn btn-soft-ash btn-sm !rounded-[50rem] flex items-center hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,.05)] before:not-italic before:content-['#'] before:font-normal before:pr-[0.2rem]">Photography</a></li>
            ...
            <div class="widget mt-[40px]">
              ...
              <ul class="pl-0 list-none bullet-primary !text-inherit">
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:font-SansSerif"><a class="text-inherit hover:text-[#d16b86]" href="#">February 2019</a></li>
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:font-SansSerif mt-[.35rem]"><a class="text-inherit hover:text-[#d16b86]" href="#">January 2019</a></li>
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:font-SansSerif mt-[.35rem]"><a class="text-inherit hover:text-[#d16b86]" href="#">December 2018</a></li>
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:font-SansSerif mt-[.35rem]"><a class="text-inherit hover:text-[#d16b86]" href="#">November 2018</a></li>
        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:font-SansSerif mt-[.35rem]"><a class="text-inherit hover:text-[#d16b86]" href="#">October 2018</a></li>
              </ul>
            </div>
            <!-- /.widget -->
          </aside>
      ...
      <div class="container py-16 xl:!py-20 lg:!py-20 md:!py-20">
        <div class="flex flex-wrap mx-[-15px] mt-[-30px] xl:mt-0 lg:mt-0">
          <div class="md:w-4/12 lg:w-3/12 xl:w-3/12 w-full flex-[0_0_auto] px-[15px] max-w-full xl:mt-0 lg:mt-0 mt-[30px]">
            ...
            <ul class="m-0 p-0 after:content-[''] after:block after:h-0 after:clear-both after:invisible">
              <li class="clear-both block overflow-hidden">
                <figure class="float-left !w-[3.5rem] !h-[3.5rem] rounded-[0.4rem]"><a href="./blog-post.html"><img class="rounded-[0.4rem]" src="./assets/img/photos/a4.jpg" alt="image"></a></figure>
                <div class="!relative ml-[4.25rem] mb-0">
                  <h6 class="!mb-2"> <a class="text-white hover:text-[#d16b86]" href="./blog-post.html">Magna Mollis Ultricies</a> </h6>
                  <ul class="text-[0.75rem] text-[#cacaca] m-0 p-0 list-none">
                    <li class="post-date inline-block"><i class="uil uil-calendar-alt pr-[0.2rem] align-[-.05rem] before:content-['\e9ba']"></i><span>26 Mar 2022</span></li>
                  </ul>
                  <!-- /.post-meta -->
                </div>
              ...
              <li class="mt-5 clear-both block overflow-hidden">
                <figure class="float-left !w-[3.5rem] !h-[3.5rem] rounded-[0.4rem]"> <a href="./blog-post.html"><img class="rounded-[0.4rem]" src="./assets/img/photos/a5.jpg" alt="image"></a></figure>
                <div class="!relative ml-[4.25rem] mb-0">
                  <h6 class="!mb-2"> <a class="text-white hover:text-[#d16b86]" href="./blog-post.html">Ornare Nullam Risus</a> </h6>
                  <ul class="text-[0.75rem] text-[#cacaca] m-0 p-0 list-none">
                    <li class="post-date inline-block"><i class="uil uil-calendar-alt pr-[0.2rem] align-[-.05rem] before:content-['\e9ba']"></i><span>16 Feb 2022</span></li>
                  </ul>
                  <!-- /.post-meta -->
              ...
              <li class="mt-5 clear-both block overflow-hidden">
                <figure class="float-left !w-[3.5rem] !h-[3.5rem] rounded-[0.4rem]"><a href="./blog-post.html"><img class="rounded-[0.4rem]" src="./assets/img/photos/a6.jpg" alt="image"></a></figure>
                <div class="!relative ml-[4.25rem] mb-0">
                  <h6 class="!mb-2"> <a class="text-white hover:text-[#d16b86]" href="./blog-post.html">Euismod Nullam Fusce</a> </h6>
                  <ul class="text-[0.75rem] text-[#cacaca] m-0 p-0 list-none">
                    <li class="post-date inline-block"><i class="uil uil-calendar-alt pr-[0.2rem] align-[-.05rem] before:content-['\e9ba']"></i><span>8 Jan 2022</span></li>
                  </ul>
                  <!-- /.post-meta -->
          ...
          <div class="md:w-4/12 lg:w-3/12 xl:w-3/12 w-full flex-[0_0_auto] px-[15px] max-w-full xl:mt-0 lg:mt-0 mt-[30px]">
            <div class="widget">
              ...
              <ul class="pl-0 list-none tag-list">
                <li class="mt-0 mb-[0.45rem] mr-[0.2rem] inline-block"><a href="#" class="btn btn-soft-ash !text-white btn-sm !rounded-[50rem] flex items-center hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,.05)] before:not-italic before:content-['#'] before:font-normal before:pr-[0.2rem]">Still Life</a></li>
                <li class="mt-0 mb-[0.45rem] mr-[0.2rem] inline-block"><a href="#" class="btn btn-soft-ash !text-white btn-sm !rounded-[50rem] flex items-center hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,.05)] before:not-italic before:content-['#'] before:font-normal before:pr-[0.2rem]">Urban</a></li>
                <li class="mt-0 mb-[0.45rem] mr-[0.2rem] inline-block"><a href="#" class="btn btn-soft-ash !text-white btn-sm !rounded-[50rem] flex items-center hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,.05)] before:not-italic before:content-['#'] before:font-normal before:pr-[0.2rem]">Nature</a></li>
                <li class="mt-0 mb-[0.45rem] mr-[0.2rem] inline-block"><a href="#" class="btn btn-soft-ash !text-white btn-sm !rounded-[50rem] flex items-center hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,.05)] before:not-italic before:content-['#'] before:font-normal before:pr-[0.2rem]">Landscape</a></li>
              </ul>
            </div>
            <!-- /.widget -->
            <div class="widget">
              ...
              <ul class="pl-0 list-none text-inherit bullet-white ">
                <li class="relative pl-4 before:absolute before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:text-white before:font-SansSerif"><a class="text-[#cacaca] hover:text-[#d16b86]" href="#">Lifestyle (21)</a></li>
                <li class="mt-[0.35rem] relative pl-4 before:absolute before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:text-white before:font-SansSerif"><a class="text-[#cacaca] hover:text-[#d16b86]" href="#">Photography (19)</a></li>
                <li class="mt-[0.35rem] relative pl-4 before:absolute before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:text-white before:font-SansSerif"><a class="text-[#cacaca] hover:text-[#d16b86]" href="#">Journal (16)</a></li>
              </ul>
            </div>
            <!-- /.widget -->
          </div>
          ...
          <div class="md:w-4/12 lg:w-3/12 xl:w-3/12 w-full flex-[0_0_auto] px-[15px] max-w-full xl:mt-0 lg:mt-0 mt-[30px]">
            <div class="widget">
              ...
              <a class="text-[#cacaca] hover:text-[#d16b86]" href="mailto:first.last@email.com">info@email.com</a><br> 00 (123) 456 78 90
            </div>
            <!-- /.widget -->
          ...
          <div class="md:w-4/12 lg:w-3/12 xl:w-3/12 w-full flex-[0_0_auto] px-[15px] max-w-full xl:mt-0 lg:mt-0 mt-[30px]">
            <div class="widget">
              ...
              <ul class="pl-0 list-none text-inherit  !mb-0">
                <li><a class="text-[#cacaca] hover:text-[#d16b86]" href="#">About Us</a></li>
                <li class="mt-[0.35rem]"><a class="text-[#cacaca] hover:text-[#d16b86]" href="#">Our Story</a></li>
                <li class="mt-[0.35rem]"><a class="text-[#cacaca] hover:text-[#d16b86]" href="#">Projects</a></li>
              </ul>
            </div>
            <!-- /.widget -->
            <div class="widget mt-[1rem]">
              ...
              <ul class="pl-0 list-none text-inherit  !mb-0">
                <li><a class="text-[#cacaca] hover:text-[#d16b86]" href="#">Support</a></li>
                <li class="mt-[0.35rem]"><a class="text-[#cacaca] hover:text-[#d16b86]" href="#">Get Started</a></li>
                <li class="mt-[0.35rem]"><a class="text-[#cacaca] hover:text-[#d16b86]" href="#">Contact Us</a></li>
              </ul>
            </div>
            <!-- /.widget -->
          </div>
        ...
        <!--/.row -->
        <p class="mt-6  !mb-0 !text-center">© 2024 Sandbox. All rights reserved.</p>
      </div>
      <!-- /.container -->
    </footer>
  <!-- progress wrapper -->
