...
export const metadata = {
  title:
    "مشاريعنا - KodKraft - شركة تطوير البرمجيات الرائدة في لبنان",
  description:
    "اطلع على محفظة KodKraft – مواقع ويب وتطبيقات ومشاريع علامة تجارية مصممة بجمال لسهولة الاستخدام والأداء ونمو الأعمال.",
};
