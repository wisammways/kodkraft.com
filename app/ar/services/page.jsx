...
export const metadata = {
  title:
    "خدماتنا - KodKraft - شركة تطوير البرمجيات الرائدة في لبنان",
  description:
    "من تطوير الويب المتجاوب إلى تحسين محركات البحث والعلامة التجارية، تقدم KodKraft حلولاً رقمية عالية الأداء مصممة خصيصاً لأهداف عملك. استكشف خدماتنا.",
};
