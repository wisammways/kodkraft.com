...
export const metadata = {
  title:
    "تواصل معنا - KodKraft - شركة تطوير البرمجيات الرائدة في لبنان",
  description:
    "مستعد لرفع حضورك الرقمي؟ تواصل مع فريق KodKraft اليوم للحصول على حلول مخصصة للويب والهاتف المحمول والعلامة التجارية. دعنا نتعاون!",
};
