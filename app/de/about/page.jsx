          ...
          <div className="container py-[4.5rem] xl:!py-24 lg:!py-24 md:!py-24">
            ...
            <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px] !mb-[4.5rem] xl:!mb-[7rem] lg:!mb-[7rem] md:!mb-[7rem] items-center">
              ...
              <div className="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] !mt-[50px] max-w-full">
                ...
                <p className="!mb-6">
                  Wir sind ein Team aus qualifizierten Entwicklern, Grafikdesignern und UX-Spezialisten, vereint durch eine gemeinsame Leidenschaft für die Schaffung außergewöhnlicher digitaler Erfahrungen. Bei KodKraft bringen wir Kreativität, Präzision und Innovation in jedes Projekt ein und stellen sicher, dass jede Lösung auf Ihre individuellen Bedürfnisse zugeschnitten ist. Gemeinsam streben wir danach, Websites und Apps zu erstellen, die visuell beeindruckend, benutzerfreundlich und auf Erfolg ausgelegt sind.
                </p>
                {/*/.row */}
              </div>
              {/*/column */}
                  ...
                  <div className="card-body p-6">
                    <div className="flex flex-row">
                      ...
                      <div>
                        ...
                        <p className="!mb-0">
                          Wir arbeiten zusammen, um Ihre Ziele, den Umfang und die Anforderungen zu definieren.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body p-6">
                    <div className="flex flex-row">
                      ...
                      <div>
                        ...
                        <p className="!mb-0">
                          Wir testen gründlich und stellen Ihr Projekt für nahtlose Leistung bereit.
                        </p>
                      </div>
                    </div>
                  </div>
