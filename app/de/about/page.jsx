...
export const metadata = {
  ...
  title: "Über uns - KodKraft - Führendes Softwareentwicklungsunternehmen im Libanon",
  description:
    "Erfahren Sie mehr über KodKrafts Mission, außergewöhnliche digitale Lösungen zu liefern. Lernen Sie unser talentiertes Team aus Entwicklern, Designern und digitalen Strategen kennen, die sich für Ihren Erfolg einsetzen.",
  alternates: {
            ...
            <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px] !mb-[4.5rem] xl:!mb-[7rem] lg:!mb-[7rem] md:!mb-[7rem] items-center">
              ...
              <div className="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] !mt-[50px] max-w-full">
                ...
                <p className="lead !text-[1.05rem] !leading-[1.6] font-medium">
                  Wir sind eine Agentur, die innovative Strategie mit modernster Design- und Entwicklungsexpertise kombiniert.
                </p>
                <p className="!mb-6">
                  Wir sind ein Team aus erfahrenen Entwicklern, Grafikdesignern und UX-Spezialisten, vereint durch eine gemeinsame Leidenschaft für die Schaffung außergewöhnlicher digitaler Erfahrungen. Bei KodKraft bringen wir Kreativität, Präzision und Innovation in jedes Projekt ein und stellen sicher, dass jede Lösung auf Ihre individuellen Bedürfnisse zugeschnitten ist. Gemeinsam streben wir danach, Websites und Apps zu erstellen, die visuell beeindruckend, benutzerfreundlich und auf Erfolg ausgerichtet sind.
                </p>
                {/*/.row */}
              </div>
              {/*/column */}
            ...
            <div className="flex flex-wrap mx-[-15px] !mb-5">
              <div className="md:w-10/12 lg:w-10/12 xl:w-8/12 xxl:w-7/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mx-auto !text-center">
                ...
                <h2 className="!text-[calc(1.305rem_+_0.66vw)] font-bold xl:!text-[1.8rem] !leading-[1.3] !mb-4 xl:!px-[4.5rem] lg:!px-[4.5rem]">
                  Hier sind 3 optimierte Schritte, um Ihre digitalen Projekte zum Leben zu erwecken.
                </h2>
              </div>
              {/* /column */}
            </div>
            ...
            <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px] items-center">
                ...
                <div className="card xl:!mr-6 lg:!mr-6">
                  <div className="card-body p-6">
                    <div className="flex flex-row">
                      ...
                      <div>
                        <h4 className="!mb-1">Definieren & Planen</h4>
                        <p className="!mb-0">
                          Wir arbeiten zusammen, um Ihre Ziele, den Umfang und die Anforderungen festzulegen.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card !mt-6 xl:!ml-16 lg:!ml-16">
                  <div className="card-body p-6">
                    <div className="flex flex-row">
                      ...
                      <div>
                        <h4 className="!mb-1">Gestalten & Entwickeln</h4>
                        <p className="!mb-0">
                          Wir erstellen beeindruckende Designs und entwickeln robuste, skalierbare Lösungen.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card !mt-6 xl:mx-6 lg:mx-6">
                  <div className="card-body p-6">
                    <div className="flex flex-row">
                      ...
                      <div>
                        <h4 className="!mb-1">Testen & Starten</h4>
                        <p className="!mb-0">
                          Wir testen gründlich und stellen Ihr Projekt für eine reibungslose Leistung bereit.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] !mt-[50px] max-w-full">
                ...
                <p className="lead !text-[1.05rem] !leading-[1.6] font-medium xl:!pr-5 lg:!pr-5">
                  Entdecken Sie, wie wir Ihre Ideen mit unserem bewährten Prozess in leistungsstarke Lösungen verwandeln.
                </p>
                <p>
                  Wir kombinieren Kreativität, Technologie und Strategie, um außergewöhnliche Ergebnisse zu liefern. Unser Team arbeitet eng mit Ihnen zusammen, um sicherzustellen, dass jedes Detail mit Ihrer Vision und Ihren Geschäftszielen übereinstimmt. Vom Konzept bis zum Start priorisieren wir Qualität, Innovation und Benutzererfahrung.
