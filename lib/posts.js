...
export function getAllPosts(language = 'en') {
  // For now, we only have English posts
  // In the future, language-specific posts can be loaded from posts-de.json, etc.
...
export function getPostBySlug(slug, language = 'en') {
  // For now, we only have English posts
  // In the future, language-specific posts can be loaded here
